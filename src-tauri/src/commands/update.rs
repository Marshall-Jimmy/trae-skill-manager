...
fn emit(app: &tauri::AppHandle, event: crate::models::InstallOutputEvent) {
...
pub async fn update_skill_streamed(
    ...
    emit(&app, crate::models::InstallOutputEvent::Stdout {
    ...
    .await
    {
        ...
        Err(e) => {
            emit(&app, crate::models::InstallOutputEvent::Stderr {
    ...
    if install_success {
        ...
        emit(&app, crate::models::InstallOutputEvent::Done {
            success: true,
        ...
        let _local_skills = crate::commands::scan::scan_directory(skills_dir);
...
pub async fn check_app_update(app: &tauri::AppHandle) -> Result<crate::models::AppUpdateInfo, String> {
    ...
    match updater.check().await {
        Ok(Some(update)) => Ok(crate::models::AppUpdateInfo {
            available: true,
        ...
        Ok(None) => Ok(crate::models::AppUpdateInfo {
            available: false,
            version: None,
            current_version: Some(current),
            notes: None,
